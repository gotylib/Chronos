...
// Программируемые периодические jobs: атрибут [Job], контекст ComposeJobContext, регистрация по типу.
namespace Chronos.Core;

/// <summary>Помечает метод job; возвращает <c>Task</c> или <c>Task&lt;CodeJobOutcome&gt;</c>.</summary>
...
/// <summary>Контекст выполнения метода с <see cref="JobAttribute"/> (exec в сервисе, HTTP).</summary>
