...
// Несколько compose-проектов «на сервер»: последовательный деплой через Master и учёт preferred location.
...
/// <summary>
/// Сценарий деплоя нескольких проектов на кластер через один вызов API Master.
/// </summary>
