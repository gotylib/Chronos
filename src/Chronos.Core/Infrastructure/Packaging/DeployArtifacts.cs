...
// Артефакты рядом с compose на агенте: упаковка файлов/папок в tar при публикации.
...
/// <summary>Запись списка артефактов в поток tar для multipart-загрузки на агента.</summary>
